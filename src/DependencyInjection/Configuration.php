            ...
            ->children()
                ...
                ->arrayNode('workflow')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->booleanNode('sync_status')
                            ->defaultTrue()
                            ->info('Keep TodoStatus in sync when the workflow state changes')
                        ->end()
                        ->arrayNode('allowed_roles')
                            ->scalarPrototype()->end()
                            ->defaultValue([])
                            ->info('Symfony roles allowed to apply workflow transitions (empty = all authenticated users)')
                        ->end()
                    ->end()
                ->end()
